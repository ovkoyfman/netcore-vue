...
.room-block .category input {
  float: left;
}
.room-block .category input:disabled {
  cursor: auto;
  display: block;
}
.room-block tr.dates td {
  height: 40px;
}
...
.header-image {
  background: url("https://images.unsplash.com/photo-1514359077460-2411095f4c2f?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=970bdb0ae8a24541733930855900f25f&auto=format&fit=crop&w=967&q=80");
  padding-bottom: 50%;
  width: 100%;
  max-width: 1120px;
...
.editable select.RoomType {
  float: left;
}
.activeDrop .enterSpace input {
